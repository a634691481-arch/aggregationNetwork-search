...
/**
 * Sleek Line Cursor（鼠标拖尾光带）
 * 移植自 Inspira UI / shadcn-vue 的 sleek-line-cursor，修正了组件名并移除全局 id 污染。
 * - 全屏覆盖，pointer-events:none，不影响交互
 * - 仅客户端运行，请用 <ClientOnly> 包裹或在 layout 末尾挂载一次
 */
